...
control MyIngress(inout headers hdr,
	...
	//if so, lookup the source MAC in the table and decide what to do (applying table)
...
control MyDeparser(packet_out packet, in headers hdr) {
    apply {
	//TODO: emit the packet with a valid Ethernet header - header emitted only if valid so don't need to check
